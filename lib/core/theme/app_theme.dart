  ...
  static ThemeData _buildDark(Color primaryClr) {
    return ThemeData(
      ...
      colorScheme: ColorScheme.fromSeed(
        ...
        brightness: Brightness.dark,
        primary: primaryClr,
        secondary: const Color(0xFF111318),
      ...
      cardTheme: CardThemeData(
        ...
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(8),
          side: BorderSide(color: primaryClr.withValues(alpha: 0.08), width: 1),
        ),
      ...
      outlinedButtonTheme: OutlinedButtonThemeData(
        style: OutlinedButton.styleFrom(
          ...
          side: BorderSide(color: primaryClr.withValues(alpha: 0.15)),
          padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 14),
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(6)),
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        border: OutlineInputBorder(
          ...
          borderSide: BorderSide(color: primaryClr.withValues(alpha: 0.1), width: 1),
        ),
        enabledBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(6),
          borderSide: const BorderSide(color: Color(0xFF1A1D24), width: 1),
        ),
