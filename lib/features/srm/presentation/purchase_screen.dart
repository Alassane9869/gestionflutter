...
class _PurchaseScreenState extends ConsumerState<PurchaseScreen> with SingleTickerProviderStateMixin {
                      ...
                      child: Row(
                        children: [
                          ...
                          Container(
                            ...
                            child: Icon(FluentIcons.cart_24_filled, color: theme.colorScheme.primary, size: 22),
                          ),
                          const SizedBox(width: 16),
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              const Text("Nouvel Achat", style: TextStyle(fontSize: 18, fontWeight: FontWeight.w900, letterSpacing: -0.5)),
                              const SizedBox(height: 2),
                              Text("Enregistrement de stock entrant", style: TextStyle(fontSize: 12, color: Colors.grey.shade500, fontWeight: FontWeight.w500)),
                            ],
                          ),
                        ],
                      ),
      ...
      children: [
                      ...
                      fieldViewBuilder: (ctx, ctrl, focus, onSubmitted) {
                        return TextField(
                          ...
                          decoration: const InputDecoration(
                            hintText: "Rechercher un produit ou scanner le code-barres...",
                            prefixIcon: Icon(FluentIcons.search_20_regular, size: 18),
                            suffixIcon: Icon(FluentIcons.barcode_scanner_24_regular, size: 20),
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    _buildHeaderLabel("QTÉ", width: 100, alignment: Alignment.center),
                    _buildHeaderLabel("PRIX UNITAIRE", width: 120, alignment: Alignment.center),
                    _buildHeaderLabel("TOTAL", width: 100, alignment: Alignment.centerRight),
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border(left: BorderSide(color: isDark ? Colors.white.withValues(alpha: 0.04) : Colors.grey.shade200, width: 1)),
          ),
          child: Column(
            children: [
              Expanded(
  ...
  Widget _buildModernSummary(double total, String currency, ThemeData theme, bool isDark) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: isDark ? theme.colorScheme.surface : Colors.white,
        border: Border(top: BorderSide(color: isDark ? Colors.white.withValues(alpha: 0.04) : Colors.grey.shade200, width: 1)),
      ),
      child: Column(
        children: [
          Container(
          ...
          SizedBox(
            ...
            child: FilledButton.icon(
              ...
              icon: const Icon(FluentIcons.checkmark_circle_24_filled, size: 20),
              label: const Text("VALIDER L'ACHAT", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w900, letterSpacing: 0.5)),
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Icon(FluentIcons.cart_24_regular, size: 64, color: isDark ? Colors.grey.shade700 : Colors.grey.shade400),
          ),
          const SizedBox(height: 24),
          Text(message ?? "Aucun article sélectionné", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: isDark ? Colors.grey.shade500 : Colors.grey.shade600)),
          const SizedBox(height: 8),
          Text("Recherchez un produit ou scannez son code-barres.", style: TextStyle(fontSize: 13, color: isDark ? Colors.grey.shade600 : Colors.grey.shade500)),
        ],
      ),
    );
  }
