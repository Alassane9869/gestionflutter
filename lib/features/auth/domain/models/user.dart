...
class UserPermissions with _$UserPermissions {
  const factory UserPermissions({
    ...
    @Default(true) bool canUseAi,
    @Default(false) bool canViewGlobalSalesHistory,
    @Default(false) bool canViewDashboard,
    @Default(false) bool canManageProducts,
    @Default(false) bool canDeleteSales,
  }) = _UserPermissions;
  ...
  factory UserPermissions.admin() => const UserPermissions(
        ...
        canManageHR: true,
        canUseAi: true,
        canViewGlobalSalesHistory: true,
  ...
  factory UserPermissions.cashier() => const UserPermissions(
        ...
        canManageHR: false,
        canUseAi: true,
        canViewGlobalSalesHistory: false,
        canViewDashboard: false, // Default false for security
...
class User with _$User {
  ...
  bool get canUseAi => isAdmin || isAdminPlus ? true : permissions.canUseAi;

  // Custom Granular Guards
  bool get canViewGlobalSalesHistory => isAdmin || isManager || isAdminPlus || permissions.canViewGlobalSalesHistory;
  bool get canViewDashboard => isAdmin || isManager || isAdminPlus || permissions.canViewDashboard;
  bool get canManageProducts => isAdmin || isManager || isAdminPlus || permissions.canManageProducts;
  bool get canDeleteSales => isAdmin || isAdminPlus || permissions.canDeleteSales;
