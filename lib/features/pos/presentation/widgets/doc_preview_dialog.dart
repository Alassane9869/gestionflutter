                      ...
                      onPressed: () async {
                        ...
                        if (directPrintCallback != null) {
                          ...
                          if (doc != null) {
                            ...
                            if (settings != null) {
                              if (_showTicket) {
                                targetPrinter = settings.thermalPrinterName;
                              } else {
                                final isDelivery = widget.invoiceFileName.toLowerCase().contains("livraison");
                                final isProforma = widget.invoiceFileName.toLowerCase().contains("proforma");
                                if (isDelivery) {
                                  targetPrinter = settings.deliveryPrinterName;
                                } else if (isProforma) {
                                  targetPrinter = settings.proformaPrinterName;
                                } else {
                                  targetPrinter = settings.invoicePrinterName;
                                }
                              }
                            }
