            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "Ce produit est actuellement à 0 en stock.\nVoulez-vous quand même l'ajouter au panier ?\n(Utile pour générer un devis)",
                    style: TextStyle(
                      fontSize: 12,
                    ...
                    children: [
                      ...
                      Expanded(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          icon: const Icon(FluentIcons.cart_24_regular, size: 16, color: Colors.white),
                          label: const Text(
                            "AJOUTER QUAND MÊME",
                            style: TextStyle(
                              fontWeight: FontWeight.w900,
  ...
  Future<void> _openCheckout() async {
    ...
    await showDialog(
      ...
      builder: (_) => PremiumCheckoutDialog(
        ...
        cashierName: user?.fullName ?? 'Caissier',
        onConfirmed: (
              paid,
              change,
              totalAmount,
