...
class InvoiceData {
  ...
  double get netTTC => (subtotal - discountAmount).clamp(0.0, double.infinity);
  double get taxAmount => netTTC - (netTTC / (1 + taxRate));
  double get subtotalHT => subtotal / (1 + taxRate);
  double get discountHT => discountAmount / (1 + taxRate);
  double get discountToShow => shouldBeDetailed ? discountHT : discountAmount;
      ...
      children: [
        ...
        pw.Padding(
          ...
          child: pw.Text(
            ...
            style: pw.TextStyle(
              fontSize: 9,
              fontWeight: warn ? pw.FontWeight.bold : pw.FontWeight.normal,
              color: color,
            ),
          ),
        ),
      ...
      children: [
        pw.Text(
          ...
          style: pw.TextStyle(
            fontSize: fontSize,
            fontWeight: bold ? pw.FontWeight.bold : pw.FontWeight.normal,
            color: warn ? PdfColors.red700 : PdfColors.black,
          ),
        ),
        pw.Text(
          value,
