...
enum NetworkMode { solo, server, client, cloud }
...
class ShopSettings {
  ...
  final Map<String, bool>? _copilotPermissions; // Stockage interne
  Map<String, bool> get copilotPermissions {
    final defaultMap = {
      'navigate': true,
      'change_theme': true,
      'add_product': true,
      ...
      'update_client': true,
      'delete_client': true,
      'settle_client_debt': true,
      'get_client_debtors': true,
      ...
      'get_top_profitable_items': true,
    };
    if (_copilotPermissions == null) return defaultMap;
    final map = Map<String, bool>.from(defaultMap);
    _copilotPermissions.forEach((key, value) {
      map[key] = value;
    });
    return map;
  }
  ...
  final String cloudAiProvider; // 'gemini' ou 'deepseek'
  ...
  const ShopSettings({
    ...
    this.cloudSyncKey = '',
    this.cloudEndpoint = 'https://danaya-plus-default-rtdb.firebaseio.com',
    ...
    Map<String, bool>? copilotPermissions = const <String, bool>{},
    ...
    this.enableVoiceConfig = false,
    this.useCloudAi = false,
    this.cloudAiProvider = 'gemini',
    this.deepSeekApiKey = '',
    this.geminiApiKey = '',
    ...
    this.useDetailedTaxOnDeliveryNotes = false,
       ...
       _copilotPermissions = copilotPermissions;
  ...
  ShopSettings copyWith({
    ...
    bool? isAiEnabled,
    bool? isVoiceEnabled,
    bool? enableVoiceConfig,
    bool? useCloudAi,
    String? cloudAiProvider,
    ...
    Map<String, bool>? copilotPermissions,
    String? labelHT,
    String? labelTTC,
    String? titleInvoice,
    String? titleReceipt,
    ...
    return ShopSettings(
      ...
      enableVoiceConfig: enableVoiceConfig ?? this.enableVoiceConfig,
      useCloudAi: useCloudAi ?? this.useCloudAi,
      cloudAiProvider: cloudAiProvider ?? this.cloudAiProvider,
      ...
      copilotPermissions:
          copilotPermissions ?? this.copilotPermissions,
