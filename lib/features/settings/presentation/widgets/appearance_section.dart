...
class AppearanceSettingsSection extends ConsumerWidget {
    ...
    return Column(
      ...
      children: [
        ...
        PremiumSettingsWidgets.buildSectionHeader(
          ...
          subtitle: "Affichez ou masquez les sections de la vue d'ensemble",
          color: c.violet,
        ),
        const SizedBox(height: 12),
        PremiumSettingsWidgets.buildCard(
          ...
          child: Column(
            children: [
              _buildDashboardSectionToggle(
                context,
                ref,
                "Indicateurs Clés (KPIs)",
                "Affiche les KPIs principaux (Chiffre d'Affaires, Ventes, Panier Moyen, Résultat Net)",
                customization.showKpis,
                (val) => ref.read(dashboardCustomizationProvider.notifier).toggleSection('kpis', val),
                c,
              ),
              const Divider(),
              _buildDashboardSectionToggle(
                ...
                "Affiche l'évolution du chiffre d'affaires des 7 derniers jours",
                customization.showRevenueChart,
                (val) => ref.read(dashboardCustomizationProvider.notifier).toggleSection('revenue_chart', val),
                c,
              ),
              const Divider(),
              _buildDashboardSectionToggle(
                ...
                ref,
                "Mix Produits",
                "Affiche le graphique circulaire du top des ventes par produit",
                customization.showProductMix,
                (val) => ref.read(dashboardCustomizationProvider.notifier).toggleSection('product_mix', val),
                c,
              ),
              const Divider(),
              _buildDashboardSectionToggle(
                ...
                "Affiche la liste des articles les plus vendus",
                customization.showTopSales,
                (val) => ref.read(dashboardCustomizationProvider.notifier).toggleSection('top_sales', val),
                c,
              ),
              const Divider(),
              _buildDashboardSectionToggle(
                ...
                ref,
                "Activité Récente",
                "Affiche les dernières transactions de la journée",
                customization.showRecentSales,
                (val) => ref.read(dashboardCustomizationProvider.notifier).toggleSection('recent_sales', val),
                c,
              ),
              const Divider(),
              _buildDashboardSectionToggle(
                ...
                ref,
                "Alertes de Stock",
                "Affiche les produits en rupture ou en stock faible",
                customization.showStockAlerts,
                (val) => ref.read(dashboardCustomizationProvider.notifier).toggleSection('stock_alerts', val),
                c,
              ),
              const Divider(),
              _buildDashboardSectionToggle(
                ...
                ref,
                "Résumé Financier",
                "Affiche la valeur globale du stock, les dépenses et les profits",
                customization.showFinancialSummary,
                (val) => ref.read(dashboardCustomizationProvider.notifier).toggleSection('financial_summary', val),
                c,
              ),
              const Divider(),
              _buildDashboardSectionToggle(
                ...
                ref,
                "Dettes Clients",
                "Affiche la liste des clients débiteurs les plus importants",
                customization.showDebtors,
                (val) => ref.read(dashboardCustomizationProvider.notifier).toggleSection('debtors', val),
                c,
              ),
            ],
          ),
  ...
  Widget _buildDashboardSectionToggle(
