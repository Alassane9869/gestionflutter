...
class _SetupWizardScreenState extends ConsumerState<SetupWizardScreen> {
  ...
  final _cloudEndpointCtrl = TextEditingController(text: 'https://danaya-plus-default-rtdb.firebaseio.com');
    ...
    return Column(
      ...
      children: [
        ...
        _buildNetworkOption(
          ...
          title: "POSTE DISTANT (CLOUD)",
          subtitle: "Connectez-vous à distance à votre magasin via le Cloud.",
        ...
        if (_networkMode == NetworkMode.cloud) ...[
          const SizedBox(height: 32),
          const Divider(),
          const SizedBox(height: 16),
          EnterpriseWidgets.buildPremiumTextField(
            context, 
            ctrl: _cloudSyncKeyCtrl, 
