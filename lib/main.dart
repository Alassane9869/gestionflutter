...
Future<void> main() async {
  ...
  // Filtre les erreurs connues du moteur Flutter Windows (AXTree accessibility bug)
  FlutterError.onError = (FlutterErrorDetails details) {
    final errorStr = details.toString();
    // Ignorer les erreurs AXTree du moteur Windows (bug connu Flutter Engine)
    if (errorStr.contains('AXTree') || errorStr.contains('accessibility_bridge')) {
      return; // Silencieusement ignoré - pas un vrai problème applicatif
    }
  ...
  PlatformDispatcher.instance.onError = (error, stack) {
    ...
    // Ignorer les erreurs AXTree du moteur Windows (bug connu Flutter Engine)
    if (errorStr.contains('AXTree') || errorStr.contains('accessibility_bridge')) {
      return true; // Avalé silencieusement
    }
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      builder: (context, child) {
        ...
        // "Failed to update ui::AXTree" très fréquent sur Flutter Windows.
